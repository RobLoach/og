...
/**
 * Define organic groups permissions.
 *
 * @return
 *   An array whose keys are permission names and whose corresponding values
 *   are arrays containing the following key-value pairs.  Note that most of
 *   these keys are identical to the allowed keys for the hook_permission()
 *   hook, with the exception of 'default role', 'roles', 'module', and 'groups'.
 ...
 *     permission to trusted users.  When set to TRUE, a warning message
 *     is displayed on the permission page.  Also, the permission is only
 *     displayed on the OG permission overview page if the user viewing the
 *     page has the 'administer group' permission.
 *     Defaults to FALSE.
 ...
 *   - roles: (optional) An array of role names specifying the roles that can
 *     possibly be given the permission.
 *     Defaults to array(OG_ANONYMOUS_ROLE, OG_AUTHENTICATED_ROLE).
 *   - default role: (optional) An array of role names specifying the roles that
 *     are given the permission by default.
 *   - module: (optional) The machine name of the module that is defining
 *     the permission.
 *     Defaults to the name of the module implementing hook_og_permission.
 *   - groups: (optional) An array used to limit the groups which can use the
 *     permission.  The array is keyed by $group_type; the value for each
 *     $group_type is an array keyed by the bundle names of the groups which can
 *     use the permission.
 *     Defaults to empty, which means the permission is available for all
 *     groups.
 *
 * @see og_get_permissions()
 */
